...
-- CreateIndex
CREATE INDEX "Card_catalogId_idx" ON "Card"("catalogId");
...
-- AddForeignKey
ALTER TABLE "Card" ADD CONSTRAINT "Card_catalogId_fkey" FOREIGN KEY ("catalogId") REFERENCES "Catalog"("id") ON DELETE SET NULL ON UPDATE CASCADE;
